/* main.c : Testing mainline for Lab #3
...
int main(int argc, char* argv[])
{
	...
	rc = rand() % 1024;   														// Choose a number from 0 to 1023 (there are 1024 bytes to choose from that can be altered)
	iBit = rand() % 8;	  														// Choose a number from 0 to 7 (one of the 8 bits in the chosen byte)
	iMask = 1 << iBit;	  														// Left shift 0000 0001 by a random number of bits from 0 to 7 (to select bit)
